<template>
    <div id="detailContraniner" class="silide-enter-active">
		<Header title="影片详情">
...
<style>
#detailContraniner{ position: absolute;left: 0; top: 0; z-index: 100; min-height: 100%;background: white; }
#detailContraniner.silide-enter-active{ animation: 0.3s silideMove;}
@keyframes silideMove {
